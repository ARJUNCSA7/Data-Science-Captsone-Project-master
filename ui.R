...
shinyUI(   fluidPage(
  ...
  mainPanel(
    ...
    wellPanel(
      h4("Details"),
      HTML("<p> Github Repository <a href='https://github.com/ARJUNCSA7/Data-Science-Captsone-Project' target='_blank'>https://github.com/ARJUNCSA7/Data-Science-Captsone-Project</a></p>"),
